...
#define SEMIWRAP_SUPPRESS_DEPRECATED_BEGIN \
    _Pragma("clang diagnostic push") \
    _Pragma("clang diagnostic ignored \"-Wdeprecated-declarations\"")
#define SEMIWRAP_SUPPRESS_DEPRECATED_END _Pragma("clang diagnostic pop")
#elif defined(__GNUC__)
#define SEMIWRAP_SUPPRESS_DEPRECATED_BEGIN \
    _Pragma("GCC diagnostic push") \
    _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"")
#define SEMIWRAP_SUPPRESS_DEPRECATED_END _Pragma("GCC diagnostic pop")
#elif defined(_MSC_VER)
#define SEMIWRAP_SUPPRESS_DEPRECATED_BEGIN \
    __pragma(warning(push)) __pragma(warning(disable : 4996))
#define SEMIWRAP_SUPPRESS_DEPRECATED_END __pragma(warning(pop))
#else
#define SEMIWRAP_SUPPRESS_DEPRECATED_BEGIN
#define SEMIWRAP_SUPPRESS_DEPRECATED_END
#endif
